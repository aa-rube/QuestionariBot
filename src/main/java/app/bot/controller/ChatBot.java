...
public class ChatBot extends TelegramLongPollingBot {
    ...
    private void inlineAnswer(Update update) {
        ...
        for (Questioner questioner : questioners) {
            if (questioner.getName().toLowerCase().contains(query.toLowerCase())) {
                InlineQueryResultArticle article = inlineQueryData.getInlineQueryResult(botConfig.getBotUserName(),questioner);
    ...
    private void saveUsersTest(Long chatId) {
